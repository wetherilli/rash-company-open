...
const SYNERGIES = [
  ...
  { tag: "제4발톱", name: "제4발톱", need: 2, atk: 0.10, hp: 0.15, desc: "피의 아름다움" },
...
const SINNERS = {
  ...
  lee_hanbeom: {
    ...
    ids: [
      ...
      { star: 2, title: "올림피아드 우승자",      atk: 20, def: 6,  hp: 70, note: "이정도는 기본이지." },
  ...
  seong_siyun: {
    ...
    ids: [
      ...
      { star: 2, title: "모나크 집사",       atk: 19, def: 8,  hp: 76, note: "이번건, 중요하겠네요." },
