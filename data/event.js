...
const EVENTS = [
  ...
  },
  {
    ...
    from:    "2026-09-11",         /* 7장을 올린 날부터 — 부산행과 하루 겹칩니다 */
    /* 처음엔 7일(~09-18)이었습니다. 7.5장 병합이 한 주 미뤄지면서(그림 준비 —
     * 사용자 지침 2026-09-18) 14일로 늘려 09-25 0시까지 엽니다. 우편함의
     * 「이벤트 기간 연장 보상」(범블비 100)이 이 연장 몫입니다. */
    days:    14,
    goods: [
